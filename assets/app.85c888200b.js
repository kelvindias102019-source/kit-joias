!function(f,b,e,v,n,t,s)
  ...
  fbq('track', 'ViewContent', {
    content_name: 'Kit 54 SemiJoias Completo Folheada Ouro 18k Prata 925 Colar/Brincos Refinados Revenda',
    content_type: 'product',
    content_ids: ['kit-54-semijoias'],
    currency: 'BRL',
    value: 57.98
  });
  ...
  (() => {
    ...
    window.openIntegratedCheckout=()=>{
      ...
      refreshTotals();
      const metaCheckoutQty=Math.max(1,Math.min(3,Number(sessionStorage.getItem('brbbCartQty')||q||1)));
    ...
    document.getElementById('coPayPix').addEventListener('click',()=>{
      ...
      if(onlyDigits(cep.value).length!==8 || !street.value || !city.value || !uf.value){
        return showNotice('Endereço incompleto','Consulte um CEP válido antes de continuar.');
      }
